...
```{r}
#Converting the data set into time series object
CanjapTSDCCopen<- ts(CanadianJapanCurrencyDCC$Open,    frequency = 314, start= c(2000,01,03))
CanjapTSDCCclose <- ts(CanadianJapanCurrencyDCC$Close, frequency = 314, start = c(2000,01,03))
CanjapTSDCC <- cbind(CanjapTSDCCclose, CanjapTSDCCopen)
plot.ts(CanjapTSDCC)
